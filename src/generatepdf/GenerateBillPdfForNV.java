...
public class GenerateBillPdfForNV {
	private LuongDao luongDao;
	private List<Luong> dsLuong;
	private NhanVienDao nvDao;
	private List<NhanVien> dsNV;

	public GenerateBillPdfForNV(String maLuong, String tenKT, String tenNV) {
		...
		try {
			...
			Paragraph p2 = new Paragraph("PHIẾU XUẤT LƯƠNG NHÂN VIÊN", f2);
